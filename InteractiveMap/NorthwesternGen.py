...
class NorthwesternGen:

    def buildSheet(self):

        web_page = requests.get('https://economics.northwestern.edu/people/faculty/')
        ...
        addToWb("Northwestern University", r"C:\Users\jcpat\SummerResearch2022\InteractiveMap\EconomicsFaculty.xlsx", df)

if __name__ == "__main__":

    Northwestern = NorthwesternGen()
    Northwestern.buildSheet()
