...
class UPennGen:
    ...
    def buildSheet(self):
        ...
        web_page = requests.get('https://economics.sas.upenn.edu/people/faculty')

        soup = BeautifulSoup(web_page.text, 'html.parser')

        names = soup.find_all('h3')
        titles = soup.find_all('h4', attrs = {'class' : 'col-sm-5'})
        ...
        addToWb("University of Pennsylvania", r"C:\Users\jcpat\SummerResearch2022\InteractiveMap\EconomicsFaculty.xlsx", df)
