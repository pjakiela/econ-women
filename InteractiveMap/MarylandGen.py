...
class MarylandGen:
    ...
    def buildSheet(self):
        ...
        web_page = requests.get('https://www.econ.umd.edu/facultystaff/Faculty', verify = False)
    ...
    #    soup = BeautifulSoup(web_page.text, 'html.parser')
        ...
        #data = soup.find_all('td', attrs = {'class' : 'views-field views-field-nothing views-field-field-position-title'})
